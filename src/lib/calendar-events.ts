...
export const DEFAULT_EVENT_COLORS: Record<CalendarEventType, { color: string; icon: string; label: string }> = {
  chemo:              { color: '#e74c3c', icon: '💉', label: 'Chemioterapia' },
  chemo_postponed:    { color: '#c0392b', icon: '⏸️', label: 'Chemia odroczona' },
  blood_test:         { color: '#3498db', icon: '🩸', label: 'Wyniki krwi' },
  imaging:            { color: '#9b59b6', icon: '🏥', label: 'Badanie obrazowe' },
  daily_log:          { color: '#27ae60', icon: '📝', label: 'Dziennik' },
  supplement:         { color: '#f39c12', icon: '💊', label: 'Suplementy' },
  doctor_visit:       { color: '#1abc9c', icon: '👨‍⚕️', label: 'Wizyta lekarska' },
  side_effect:        { color: '#e67e22', icon: '⚠️', label: 'Efekt uboczny' },
  weight:             { color: '#7f8c8d', icon: '⚖️', label: 'Waga' },
  wearable_alert:     { color: '#c0392b', icon: '⌚', label: 'Alert opaski' },
  prediction:         { color: '#2c3e50', icon: '🔮', label: 'Predykcja' },
  medication_change:  { color: '#d35400', icon: '🔄', label: 'Zmiana leczenia' },
  note:               { color: '#95a5a6', icon: '📌', label: 'Notatka' },
